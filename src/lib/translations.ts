...
export const translations: Record<string, TranslationShape> = {
  en: {
    ...
    historyViewInHistory: "View in History",
    promptSaveError: "Could not save to history",

    // History
    historyNavLabel: "History",
    historyPageTitle: "Prompt History",
    historyEmptyTitle: "No prompts yet",
    historyEmptyBody: "Generate your first prompt using the form to see it here.",
    historyVersionCount: (n) => `${n} version${n === 1 ? "" : "s"}`,
    historyLatestBadge: "Latest",
    historyBackToList: "Back to History",
    historyVersionLabel: "Version",
    historyCreatedLabel: "Created",
    historyEditBtn: "Edit / New Version",
    historyEditPageTitle: "Create New Version",
    historyEditHint: (v) => `Editing v${v} will create v${v + 1}. The original is preserved.`,
    historyEditSubmitBtn: "Save as New Version",
    historyEditCancelBtn: "Cancel",
    historyCharCount: (n, max) => `${n} / ${max} characters`,
  },
  ...
  ja: {
    ...
    downloadTxtBtn: ".txtでダウンロード",
    historyViewInHistory: "履歴で見る",
    promptSaveError: "履歴への保存に失敗しました",

    // History
    historyNavLabel: "履歴",
    historyPageTitle: "プロンプト履歴",
    historyEmptyTitle: "まだプロンプトがありません",
    historyEmptyBody: "フォームで最初のプロンプトを生成するとここに表示されます。",
    historyVersionCount: (n) => `${n} バージョン`,
    historyLatestBadge: "最新",
    historyBackToList: "履歴に戻る",
    historyVersionLabel: "バージョン",
    historyCreatedLabel: "作成日時",
    historyEditBtn: "編集 / 新バージョン",
    historyEditPageTitle: "新バージョンを作成",
    historyEditHint: (v) => `v${v} を編集すると v${v + 1} が作成されます。元のバージョンは保持されます。`,
    historyEditSubmitBtn: "新バージョンとして保存",
    historyEditCancelBtn: "キャンセル",
    historyCharCount: (n, max) => `${n} / ${max} 文字`,
  },
};
